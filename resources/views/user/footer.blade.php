...
use App\Models\Contacts;
    $social = Contacts::first();

$solutionCont = new SolutionController();
$solutionData = $solutionCont->getSolutionData(app()->getLocale());
            ...
            <div class="footer_content_item">
                ...
                <ul class="footer_social">
                    <li class="footer_social_item">
                        <a href="{{json_decode($social->social)->twitter ?? ''}}" target="_blank" class="footer_social_item_link">
                    ...
                    <li class="footer_social_item">
                        <a href="{{json_decode($social->social)->facebook ?? ''}}" target="_blank" class="footer_social_item_link">
                    ...
                    <li class="footer_social_item">
                        <a href="{{json_decode($social->social)->instagram ?? ''}}" target="_blank" class="footer_social_item_link">
                            <svg id="Layer_2" data-name="Layer 2" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                    ...
                    <li class="footer_social_item">
                        <a href="{{json_decode($social->social)->youtube ?? ''}}" target="_blank" class="footer_social_item_link">
...
{{--                        <img class="footer_downloadApp_item--img" src="{{asset('views/images/appStore.svg')}}" alt="app store">--}}
{{--                    </a>--}}
{{--                    <a href="#" class="footer_downloadApp_item">--}}
{{--                        <img class="footer_downloadApp_item--img" src="{{asset('views/images/googlePlay.svg')}}" alt="app store">--}}
{{--                    </a>--}}
{{--                </div>--}}
{{--            </div>--}}
            <div class="footer_content_item">
